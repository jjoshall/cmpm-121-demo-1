...
growthRateText.textContent = `Growth rate: ${growthRate} 💎/s`; // Shows user what growth rate is
...
function updateCounter(time: number) {
  if (isCounterActive && time - lastTime >= 1000) {
    ...
    growthRateText.textContent = `Growth rate: ${growthRate.toFixed(2)} 💎/s`;
...
autoMiner10.textContent = `Pay ${autoMiner10Price.toFixed(2)} 💎 for Slow Miner`; // Setting the text of the slow auto miner button
...
autoMiner100.textContent = `Pay ${autoMiner100Price.toFixed(2)} 💎 for Fast Miner`; // Setting the text of the fastauto miner button
...
autoMiner1000.textContent = `Pay ${autoMiner1000Price.toFixed(2)} 💎 for Super Fast Miner`; // Setting the text of the super fast auto miner button
...
autoMiner10.addEventListener("click", () => {
  ...
  autoMiner10.textContent = `Pay ${autoMiner10Price.toFixed(2)} 💎 for Slow Miner! You have ${autoMiner10Counter} Slow Miners`;
  activateCounter();
});
...
autoMiner100.addEventListener("click", () => {
  ...
  autoMiner100.textContent = `Pay ${autoMiner100Price.toFixed(2)} 💎 for Fast Miner! You have ${autoMiner100Counter} Fast Miners`;
  activateCounter();
});
requestAnimationFrame(updateCounter); // Start the counter animation
...
autoMiner1000.addEventListener("click", () => {
  ...
  autoMiner1000.textContent = `Pay ${autoMiner10Price.toFixed(2)} 💎 for Super Fast Miner! You have ${autoMiner1000Counter} Super Fast Miners`;
  activateCounter();
});
requestAnimationFrame(updateCounter); // Start the counter animation
